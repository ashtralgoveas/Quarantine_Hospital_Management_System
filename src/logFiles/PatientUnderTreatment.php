...
<html>
  ...
  <body>
    ...
    <form action="" method="POST">
        <center>
          <h2 class="title">List of Patients Under Treatment</h2>
        </center>
    </form>
  </body>
<html>
...
if (isset($_POST['patient-under-treatment'])) {

  $conn = new mysqli("localhost", "root", "", "database");
  if ($conn->connect_error) {
      echo "connection Failed: " . $conn->connect_error;
  } else {
      $sql = "SELECT * FROM quarantine_details WHERE patient_condition = 'Under Treatment'";
